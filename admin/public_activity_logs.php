...
<body>
				...
				<ul class="navbar-nav">
					...
					<li class="nav-item dropdown">
						...
						<div class="dropdown-menu" aria-labelledby="actionDropdownMenuLink">
							...
							<a class="dropdown-item active" href="public_activity_logs.php">Public Activity Logs</a>
	...
	<main>
		<div class="container-fluid mt-5">
			<?php
				$sql = "SELECT * FROM activity a INNER JOIN users u ON a.user_id = u.user_id INNER JOIN accounts ac ON u.user_id = ac.user_id WHERE ac.account_type = 'Public'";
				$result = mysqli_query($conn, $sql);

				if($result->num_rows > 0){
				}
			?>
			<table class="table table-striped table-bordered" id="publicActivityLogsTable">
	...
	<script type="text/javascript">
		$(document).ready(function(){
			$('#publicActivityLogsTable').DataTable();
		});
	</script>
</body>
</html>